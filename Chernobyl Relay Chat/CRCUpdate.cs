...
namespace Chernobyl_Relay_Chat
{
    class CRCUpdate
    {
        ...
        {
            UpdateChecker updateChecker = new UpdateChecker("DeltaMiked", "Chernobyl-Relay-Chat-Rebirth", "0.4.2");
        ...
        {
            UpdateChecker updateChecker = new UpdateChecker("DeltaMiked", "Chernobyl-Relay-Chat-Rebirth", "0.4.1");
            UpdateType updateType;
            try
            {
